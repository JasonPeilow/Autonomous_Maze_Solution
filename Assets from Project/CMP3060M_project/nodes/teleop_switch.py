...
# https://github.com/PacktPublishing/ROS-Robotics-By-Example-Second-Edition/blob/master/Chapter08/Turtlesim_joy_code/turtlesim_joy.py -- also ref the book
...
def teleop_listener():
	...
	# loops the script to continuosly receive input.
	rospy.spin()
