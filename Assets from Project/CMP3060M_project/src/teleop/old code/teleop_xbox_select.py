...
from move_circle import move_circle # this can be removed # imports other script

cmd_vel_rate = [0.6, 0.8] # set rates of speed for the wheelchair.
...
def tj_callback(data):
	...
	twist = Twist()
	twist.linear.x = data.axes[1] * cmd_vel_rate[0] # 0.6
	twist.angular.z = data.axes[0] * cmd_vel_rate[1] # 0.8
	...
	# something like the above ^^ can be used to go to specific rooms autonomously.
